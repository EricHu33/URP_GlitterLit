...
half _Surface;
// --- GLITTER_ON
half _UseLightDirection;
half4 _FlatGlitterColor;
half _FlatGlitterSize;
half _FlatGlitterGlossness;
float4 _GlitterNoiseMap_ST;
// --- GLITTER_ON
CBUFFER_END
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _UseLightDirection)
    UNITY_DOTS_INSTANCED_PROP(float4 , _FlatGlitterColor)
    UNITY_DOTS_INSTANCED_PROP(float , _FlatGlitterSize)
    UNITY_DOTS_INSTANCED_PROP(float , _FlatGlitterGlossness)
...
#define _UseLightDirection      UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__UseLightDirection)
#define _FlatGlitterColor       UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4  , Metadata__FlatGlitterColor)
#define _FlatGlitterSize        UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__FlatGlitterSize)
#define _FlatGlitterGlossness   UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__FlatGlitterGlossness)
#endif
...
TEXTURE2D(_GlitterNoiseMap);    SAMPLER(sampler_GlitterNoiseMap);
